const loadGhostRiderWasmModule = require('./wasm-build/ghostrider-hash');
const wasmBuildBase64 = require('./wasm-build/ghostrider-hash-wasm-base64');
 ...
 */
module.exports = () => loadGhostRiderWasmModule({
